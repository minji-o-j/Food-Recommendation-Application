...
public class Feel_Result_Angry extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel__result__angry);
    ...
    public void showMenu(View v) {
        Intent showMenu = new Intent(Feel_Result_Angry.this, Feel_Angry.class);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent home = new Intent(Feel_Result_Angry.this, SelectMode.class);
                        startActivity(home);
                    }
