...
public class Feel_mapatofu extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_mapatofu);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_mapatofu.this, Own_Menu.class);
//        startActivity(back);
