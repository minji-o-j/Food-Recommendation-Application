...
public class Feel_tangsuyuk extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_tangsuyuk);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_tangsuyuk.this, Own_Menu.class);
//        startActivity(back);
