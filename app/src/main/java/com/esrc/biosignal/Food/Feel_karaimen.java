...
public class Feel_karaimen extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_karaimen);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_karaimen.this, Own_Menu.class);
//        startActivity(back);
