...
public class Feel_hodupie extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_hodupie);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_hodupie.this, Own_Menu.class);
//        startActivity(back);
