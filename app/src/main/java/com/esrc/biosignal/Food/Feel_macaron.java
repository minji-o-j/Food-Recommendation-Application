...
public class Feel_macaron extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_macaron);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_macaron.this, Own_Menu.class);
//        startActivity(back);
