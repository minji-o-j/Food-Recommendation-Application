...
public class Feel_chickenfeet extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_chickenfeet);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_chickenfeet.this, Own_Menu.class);
//        startActivity(back);
