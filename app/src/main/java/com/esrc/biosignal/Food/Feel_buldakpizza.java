...
public class Feel_buldakpizza extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_buldakpizza);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_buldakpizza.this, Own_Menu.class);
//        startActivity(back);
