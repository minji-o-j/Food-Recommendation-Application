...
public class Feel_cheesecake extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_cheesecake);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_cheesecake.this, Own_Menu.class);
//        startActivity(back);
