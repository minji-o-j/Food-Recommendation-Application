...
public class Feel_jjambbong extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_jjambbong);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_jjambbong.this, Own_Menu.class);
//        startActivity(back);
