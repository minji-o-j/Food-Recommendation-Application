...
public class Feel_jjajang extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_jjajang);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_jjajang.this, Own_Menu.class);
//        startActivity(back);
