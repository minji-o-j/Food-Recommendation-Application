...
public class Feel_beefsushi extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_beefsushi);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_beefsushi.this, Own_Menu.class);
//        startActivity(back);
