...
public class Feel_mentaiko extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_mentaiko);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_mentaiko.this, Own_Menu.class);
//        startActivity(back);
