...
public class Feel_applepie extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_applepie);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_applepie.this, Own_Menu.class);
//        startActivity(back);
