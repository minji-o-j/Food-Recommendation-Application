...
public class Feel_ttokboki extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_ttokboki);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_ttokboki.this, Own_Menu.class);
//        startActivity(back);
