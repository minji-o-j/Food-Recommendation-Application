...
public class Feel_kkanpungi extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_kkanpungi);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_kkanpungi.this, Own_Menu.class);
//        startActivity(back);
