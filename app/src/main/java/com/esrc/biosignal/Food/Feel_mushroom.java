...
public class Feel_mushroom extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_mushroom);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_mushroom.this, Own_Menu.class);
//        startActivity(back);
