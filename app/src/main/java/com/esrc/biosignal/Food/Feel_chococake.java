...
public class Feel_chococake extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_chococake);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_chococake.this, Own_Menu.class);
//        startActivity(back);
