...
public class Feel_maratang extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_maratang);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_maratang.this, Own_Menu.class);
//        startActivity(back);
