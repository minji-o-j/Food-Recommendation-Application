...
public class Feel_chicken extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_chicken);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_chicken.this, Own_Menu.class);
//        startActivity(back);
