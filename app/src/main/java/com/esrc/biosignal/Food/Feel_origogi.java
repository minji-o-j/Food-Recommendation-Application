...
public class Feel_origogi extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel_origogi);
        //전체화면으로 설정
...
//        Intent back = new Intent(Feel_origogi.this, Own_Menu.class);
//        startActivity(back);
