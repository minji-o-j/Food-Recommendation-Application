...
public class Feel_Result_Sad extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feel__result__sad);
        // 전체 화면으로 설정
    ...
    public void showMenu(View v) {
        Intent showMenu = new Intent(Feel_Result_Sad.this, Feel_Sad.class);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent home = new Intent(Feel_Result_Sad.this, SelectMode.class);
                        startActivity(home);
                    }
